...
$(document).ready(function () {
    ...
    var fruits = '<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Adam Sandler</span></h6>,<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Will Smith</span></h6>,<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Will Smith</span></h6>'.split(',');

    for (var i = 0; i < fruits.length; i++)
        jsonData.push({id: i, name: fruits[i]});
...
$(document).ready(function () {
    ...
    var fruits = '<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Adam Sandler</span></h6>,<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Will Smith</span></h6>,<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Will Smith</span></h6>,<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Adam Sandler</span></h6>,<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Will Smith</span></h6>,<h6 class="mainSelect2"><span class="round"></span><span class="top">Groomsman</span><span class="bottomdiv">Will Smith</span></h6>'.split(',');
