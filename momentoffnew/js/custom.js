...
// });
// $(".eventscalender table td.day.today").hover(function (){
//     $("td.day.active.today").addClass(tooltip);
// });
...
//    $('.Fortabledropdownfeedback').click(function () {
//        var id = $(this).data('id');
//        if (!$(event.target).closest('.ADDGUEST').length && !$(event.target).closest('.dropdown-menu').length) {
//            if (id == 1) {
//                $('.tableguest .forrelative:nth-child(5)').show();
//            }
//            else if (id == 2) {
//                $('.tableguest .forrelative:nth-child(6)').show();
//            }
//            else {
//                $('.tableguest .forrelative:nth-child(7), .tableguest .forrelative:nth-child(8)').show();
//            }
//        }
//
//    });
    ...
    $('.Fortabledropdownfeedback ').click(function () {
        ...
        $('.ContentD').hide();
        $('.Content' + id).fadeIn();
        $('.Fortabledropdownfeedback').removeClass('active');
        $(this).addClass('active');

    });

    $('.hideMe li a').click(function () {
        $('.dropdown-menu').slideUp();
        $('.dropdown-toggle').removeClass('active1');
    });
});
...
//     $('.datepp')datetimepicker().toggle();
// }
$('.datepp .bootstrap-datetimepicker-widget').show();
$('.eventscalender a').click(function () {
    if ($(this).hasClass('active')) {
        $(".eventscalender a").removeClass("active");
        // $('.datepp .bootstrap-datetimepicker-widget').hide();
    }
    else {
        // $('.datepp .bootstrap-datetimepicker-widget').show();
        $(".eventscalender a").removeClass("active");
...
// $('.eventscalender a.today').click(function (){

// });
// $(document).ready(function() {
//     var SelectedDates = {};
//     SelectedDates[new Date('09/03/2018')] = new Date('09/03/2018');
//     SelectedDates[new Date('09/04/2018')] = new Date('09/04/2018');
//     SelectedDates[new Date('09/05/2018')] = new Date('09/05/2018');
 
//     var SeletedText = {};
//     SeletedText[new Date('09/03/2018')] = 'Holiday1';
//     SeletedText[new Date('09/04/2018')] = 'Holiday2';
//     SeletedText[new Date('09/05/2018')] = 'Holiday3'; 
...
// $(".eventscalender a").datepicker();
//     $('#selec').click(function(){
//         $('#datepicker').toggle();
// });
//  $(".datepp").click(function(){
//    $(".datepicker").show();
// });
...
// $(document).on('click', '.inviteattendee a', function () {
//     $('.appendhereattendee').append('<div class="boxs forrelative forrelativefeedback attendesanchorshow"><div class="eventattendeswidth width1"><span class="Fortableimage"><span class="fortoptext">+3</span></span></div><div class="eventattendeswidth width2"><p>GROOMSMAN</p><h6>Will Smith</h6></div><div class="eventattendeswidth width3"><div class="myDropdown2 boxs"><dl id="dropdownoptions" class="dropdown2"><dt class="boxs"><a href="javascript:void(0);" class="boxs"><span class="boxs"><b>Attending</b><span style="background-position:0px -10px"></span></a></dt><dd><ul style="display: none;"><li><a data-type="no" href="javascript:void(0);"><b>Didn’t Reply</b><span style="background-position:0px 0px"></span></a></li><li><a data-type="yes" href="javascript:void(0);"><b>Attending</b><span style="background-position: 0 -10px"></span></a></li><li><a data-type="no" href="javascript:void(0);"><b>No Attending</b><span style="background-position: 0 -20px"></span></a></li></ul></dd></dl><a href="javascript:void(0)" class="resend">Resend Invitation</a></div></div><a href="javascript:void(0)" class="deletechoice attendesanchor"><img src="img/reg_delete.svg" alt="reg_delete" class="img-responsive center-block"></a></div>');
// });
...
$(document).on('click', function (event) {
    if (!$(event.target).closest('.guestdropdown').length) {
        $('.guestdropdown').slideUp();
        $('.dropdown-toggle').removeClass('active1');
    }
});
...
$('.dropdown-toggle').click(function (event) {
    ...
    if ($(this).hasClass('active1')) {
        ...
        $(".guestdropdown").slideUp();
        $(this).next('.guestdropdown').slideDown();
    }
});
...
var tym = 3;
$(document).on('click', '.addtimeslot a', function () {
    $('.agendaadd').append('<div class="agendainner boxs"><div class="agendawidth width1"><form><div class="form-group"><input type="text" class="form-control" id="type" placeholder="For example: Start time"></div></form></div><div class="agendawidth width2 clock"><form><div class="form-group"><input type="text" class="form-control timep" ><img src="" alt=""></div></form></div><a href="javascript:void(0)" class="deletechoice deletechoice2 "><img src="img/reg_delete.svg" alt="reg_delete" class="img-responsive center-block"></a></div>');
    tym++;
...
$(document).on('click', '.deletechoice2', function () {
    $(this).parent().remove();
    tym--;
});
...
$(".dd-option").click(function () {
    // alert($(this).html())
    var a = $(this).children(".dd-option-value");
    if ((a.val() == '2') || (a.val() == '3')) {
        $(this).parents('.eventattendeswidth').children('.resend').css('color', '#e57b93');
    }
    else {
        $(this).parents('.eventattendeswidth').children('.resend').css('color', '#696b84');
    }
});
